...
class Signer:
    ...
    def generateInformation(self):
        ...
        print("\u001b[35;1m(b) Computes n=p*q and \u001b(n)=(p-1)(q-1)\u001b[0m", end='\n\n')
        print("\u001b[33;1mn: \u001b[0m", n, end='\n\n')
        print("\u001b[33;1m\u001b(n): \u001b[0m", phi, end='\n\n')


        print("\u001b[35;1m(c) Picks e such that gcd(\u001b(n),e)=1 & 1<e<\u001b(n):\u001b[0m", end='\n\n')
        ...
        print("\u001b[33;1mChecking whether gcd(e, \u001b)==1: \u001b[0m")
        print("\u001b[33;1mgcd\u001b[0m(", e, ",", phi, ")", '\n' , "=", "\u001b[33;1m", cryptomath.gcd(e, phi))
        v=False
        if cryptomath.gcd(e, phi)==1:
            v=True
        print("Verification Status: ", v, "\u001b[0m", end='\n\n')
        print("\u001b[35;1m(d) Computes d, where d is the inverse of e modulo \u001b(n)\u001b[0m", end='\n\n')
        d = cryptomath.findModInverse(e, phi)


        print("\u001b[33;1md: \u001b[0m",d, end='\n\n')

        print("\u001b[33;1mChecking whether e*d mod \u001b(n) is 1 (which is the required condition for d to be inverse of e mod \u001b(n)): \u001b[0m")
        print(e, "*", d, "mod", phi,'\n' ,"=", e*d % phi, end='\n')
        v=False
        if (e*d % phi)==1:
            # \u001b
